...
import {
  TelaAplicativo,
  useMenuAplicativo,
} from "@/components/aplicativo/tela-aplicativo";
    ...
    <TelaAplicativo abaAtiva="dashboard">
      ...
      <View style={estilos.cartaoPrincipal}>
        ...
        <Pressable
          ...
          style={estilos.botaoNovaReserva}
        >
            ...
            <View key={reserva.id} style={estilos.cartaoObjetivo}>
              <View style={estilos.linhaObjetivo}>
                ...
                <View style={estilos.areaTextoObjetivo}>
                  ...
                  <Text style={estilos.categoriaObjetivo}>
                    {reserva.categoria}
                  </Text>
                </View>

                <View style={estilos.areaValorObjetivo}>
                  <Text style={estilos.valorObjetivo}>
                    {formatarMoeda(reserva.valorAtual)}
                  </Text>
                  <Text style={estilos.metaObjetivo}>
                    de {formatarMoeda(reserva.valorMeta)}
                  </Text>
                </View>
              </View>
...
function CabecalhoReservas() {
  const { abrirMenu } = useMenuAplicativo();

  return (
    <View style={estilos.cabecalho}>
      <Pressable onPress={abrirMenu} style={estilos.botaoMenu}>
